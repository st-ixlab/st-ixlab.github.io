...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        description: "One paper accepted to VRST 2026!",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2026/one-paper-accepted-to-vrst-2026/";
        ...
        description: "Somin, Yujeong, and JiHye joined the lab!",
        section: "Posts",
        handler: () => {
          
            window.location.href = "/blog/2026/Somin-Yujeong-JiHye-joined-the-lab/";
          
        },
      },{id: "post-we-are-recruiting-undergraduate-students-for-2026-summer-internship",
        ...
        description: "Yujin and Klaudia joined the lab!",
        section: "Posts",
        handler: () => {
